...
declare class GlobalAPI {
    ...
    /** 销毁特效 */
    static debug(_sfx_id: SfxID, _fade_out: boolean | undefined): void;
    /** Debug窗口打印错误日志 */
    ...
    /** 判断对象是否为空 */
    static has_sub_str(_obj: Unit | undefined): boolean;
    /** 判断对象是否为空 */
    ...
    /** 跑马灯信息 */
    static set_skyfog(_content: string | undefined): void;
    /** 游戏内飘字信息 */
...
declare class Ability {
    ...
    /** 技能开始释放 */
    static add_state_to_target(_dir_info: Vector3, _target_point: Vector3, _target_unit: Unit | undefined): void;
    /** 打断蓄力 */
    ...
    /** 获取技能可以作用的角色列表 */
    static enter_cd(_height: Fixed, _use_fixed_release_point: boolean | undefined): Character[];
    /** 获取技能可以作用的生物列表 */
    static get_ability_can_affect_character_list_v2(_height: Fixed, _use_fixed_release_point: boolean | undefined): Creature[];
    /** 获取技能可以作用的生命体列表 */
    static get_ability_can_affect_creature_list_v2(_height: Fixed, _use_fixed_release_point: boolean | undefined): LifeEntity[];
    /** 获取技能可以作用的组件列表 */
    static get_ability_can_affect_life_entity_list_v2(_height: Fixed, _use_fixed_release_point: boolean | undefined): Obstacle[];
    /** 获取技能所在槽位 */
    ...
    /** 获取技能可以作用的角色列表 */
    static get_accumulate_ratio(_height: Fixed, _use_fixed_release_point: boolean | undefined): Character[];
    /** 获取技能可以作用的生物列表 */
    static get_affect_character_list(_height: Fixed, _use_fixed_release_point: boolean | undefined): Creature[];
    /** 获取技能可以作用的生命体列表 */
    static get_affect_creature_list(_height: Fixed, _use_fixed_release_point: boolean | undefined): LifeEntity[];
    /** 获取技能可以作用的组件列表 */
    static get_affect_lifeentity_list(_height: Fixed, _use_fixed_release_point: boolean | undefined): Obstacle[];
    /** 获取技能的作用半径 */
    ...
    /** 添加向技能槽位添加UGC技能能 */
    static upgrade_ability_level(_ability_index: AbilitySlot, _ability_id: AbilityKey, _kv_args: any, _kv_types: any): Ability;
}

declare class AbilityComp {
    /** 添加道具技能 */
    static add_ability_to_slot(_ability_id: AbilityKey, _kv_args: any, _kv_types: any): Ability;
    /** 添加道具技能 */
    ...
    /** 控制角色对指定方向执行释放指定预设技能 */
    static cast_ability_by_ability_slot_and_target(_ability_key: AbilityKey, _duration: Fixed, _direction: Vector3, _ability_slot: number | undefined): void;
    /** 控制角色对指定坐标执行释放预设技能 */
    static cast_ability_by_direction(_ability_key: AbilityKey, _duration: Fixed, _position: Vector3, _ability_slot: number | undefined): void;
    /** 控制角色对指定目标执行释放指定预设技能 */
    static cast_ability_by_position(_ability_key: AbilityKey, _duration: Fixed, _target: LifeEntity, _ability_slot: number | undefined): void;
    /** 销毁技能 */
...
declare class Character {
    /** 根据生物设置模型 */
    static change_character_prefab(_creature: Creature, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 命令角色抓举 */
    ...
    /** 开始强制位移 */
    static set_voice_enabled(_vel: Vector3, _duration: Fixed, _enable_phy: boolean | undefined): void;
    /** 命令角色移动到坐标点 */
...
declare class CharacterComp {
    ...
    /** 开始强制位移 */
    static set_face_dir(_vel: Vector3, _duration: Fixed, _enable_phy: boolean | undefined): void;
    /** 退出当前强制位移 */
    static start_forced_move(): void;
    /** 根据生物设置模型 */
    static stop_forced_move(_creature: Creature, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
}
...
declare class DisplayComp {
    ...
    /** 播放全身动画 */
    static bind_model_by_unit(_anim_id: AnimKey, _start_time: Fixed, _play_time: Fixed, _is_loop: boolean | undefined): void;
    /** 播放上半身动画 */
...
declare class EquipmentComp {
    ...
    /** 获取角色/生物持有的物品预设列表 */
    static get_equipment_by_slot(_equipment_key: EquipmentKey, _exclude_equipped: boolean | undefined, _exclude_bag: boolean | undefined): Equipment[];
    /** 获取持有的物品列表 */
...
declare class GameAPI {
    ...
    /** 创建一个生物 */
    static create_constant_wind_field(_u_key: UnitKey, _pos: Vector3, _rotation: Quaternion, _scale_ratio: Fixed, _role: Role | undefined): Creature;
    /** 创建一个触发区域 */
    static create_creature_fixed_scale(_u_key: CustomTriggerSpaceKey, _pos: Vector3, _rotation: Quaternion, _scale: Vector3, _role: Role | undefined): CustomTriggerSpace;
    /** 创建一个装饰物 */
    static create_customtriggerspace(_u_key: DecorationKey, _pos: Vector3, _rotation: Quaternion, _scale: Vector3, _parent: Unit | undefined): Decoration;
    /** 创建物品到坐标点 */
    ...
    /** 创建一个生命体 */
    static create_joint_assistant(_unit_key: UnitKey, _pos: Vector3, _rotation: Quaternion, _scale_ratio: Fixed, _role: Role | undefined): LifeEntity;
    /** 创建一个组件 */
    static create_life_entity(_u_key: UnitKey, _pos: Vector3, _rotation: Quaternion, _scale: Vector3, _role: Role | undefined): Obstacle;
    /** 创建场景界面到坐标点 */
    ...
    /** 创建一个逻辑体 */
    static create_sfx_with_socket_offset(_u_key: TriggerSpaceKey, _pos: Vector3, _rotation: Quaternion, _scale: Vector3, _role: Role | undefined): TriggerSpace;
    /** 创建一个组件组 */
    static create_triggerspace(_unit_group_id: UnitGroupKey, _pos: Vector3, _root_quaternion: Quaternion, _role: Role | undefined): UnitGroup;
    /** 创建缩放单位 */
    ...
    /** 造成伤害 */
    static customtriggerspace_prefab_has_kv(_dst: LifeEntity, _dmg: Fixed, _src: Unit | undefined, _schema: number | undefined, _data: any): void;
    /** 删除路点 */
    ...
    /** 销毁单位 */
    static destroy_unit(_unit: Unit, _destroy_children: boolean | undefined): void;
    /** 设置单位与预设是否能发生碰撞 */
    ...
    /** 创建一个组件组 */
    static equipment_prefab_has_kv(_unit_group_id: UnitGroupKey, _pos: Vector3, _root_quaternion: Quaternion, _role: Role | undefined): UnitGroup;
    /** 游戏结束 */
    ...
    /** 播放特效 */
    static play_3d_sound(_sfx_key: SfxKey, _pos: Vector3, _rot: Quaternion, _scale: Fixed, _duration: Fixed, _rate: Fixed, _with_sound: boolean | undefined): SfxID;
    /** 随机整数 */
...
declare class KVBase {
    ...
    /** 设置公告板文本颜色 */
    static set_billboard_content(_color: Color, _gradient_color_1: number | undefined, _gradient_color_2: number | undefined, _gradient_color_3: number | undefined, _gradient_color_4: number | undefined): void;
    /** 设置公告板文本字体大小 */
    static set_billboard_font_color(_font_size: number): void;
    /** 设置公告板文本颜色 */
    static set_billboard_font_size(_color: Color, _gradient_color_1: number | undefined, _gradient_color_2: number | undefined, _gradient_color_3: number | undefined, _gradient_color_4: number | undefined): void;
    /** 设置自定义值 */
...
declare class LifeComp {
    ...
    /** 使生物死亡 */
    static change_hp(_dmg_unit: Unit | undefined): void;
    /** 获取健康值 */
    static die(): Fixed;
    /** 获取最大健康值 */
    static get_hp(): Fixed;
    ...
    /** 使生物复活 */
    static is_infinite_reborn(_immediate: boolean | undefined): void;
    /** 设置自动复活 */
...
declare class LifeEntity {
    ...
    /** 根据角色设置模型 */
    static ai_command_stop_move(_character: Character, _include_ugc_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 根据生物设置模型 */
    static change_model_by_character(_creature: Creature, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 根据生物预设设置模型 */
    static change_model_by_creature(_creature_key: CreatureKey, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 获取朝向 */
    ...
    /** 根据角色设置模型 */
    static set_mass_bar_visible(_character: Character, _include_ugc_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 根据生物设置模型 */
    static set_model_by_character(_creature: Creature, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 根据生物预设设置模型 */
    static set_model_by_creature(_creature_key: CreatureKey, _include_custom_model: boolean | undefined, _inherit_scale: boolean | undefined, _inherit_capsule_size: boolean | undefined): void;
    /** 设置生命体击倒阈值 */
    ...
    /** 交换物品槽位 */
    static stop_ai(_equipment: Equipment, _slot_type: Enums.EquipmentSlotType | undefined, _slot: number | undefined): void;
    /** 生命体尝试下载具 */
...
declare class LuaAPI {
    ...
    /** 设置Tick回调 */
    static set_deadloop_check_enabled(_pre_handler: any, _post_handler: any): void;
    /** 注册单位创建回调 */
...
declare class Obstacle {
    ...
    /** 设置公告板文本颜色 */
    static set_billboard_text(_color: Color, _gradient_color_1: number | undefined, _gradient_color_2: number | undefined, _gradient_color_3: number | undefined, _gradient_color_4: number | undefined): void;
    /** 设置组件碰撞次数限制 */
...
declare class Role {
    ...
    /** 玩家进入观战 */
    static disable_unit_outline(_camp_limit: boolean | undefined, _exit_visible: boolean | undefined): void;
    /** 玩家退出观战 */
    ...
    /** 播放广告 */
    static play_2d_sound_with_params(_success_event: string, _fail_event: string, _ad_tag: string | undefined, _success_data: any, _fail_data: any): void;
    /** 播放指定剧情动画 */
    ...
    /** 重置玩家相机 */
    static reset_animation(_reset_angle: boolean | undefined, _reset_bind: boolean | undefined, _reset_point: boolean | undefined, _reset_prop_pitch: boolean | undefined): void;
    /** 恢复玩家相机运动 */
    ...
    /** 设置UI图片节点图片 */
    static set_image_color(_image: EImage, _image_key: ImageKey, _reset_size: boolean | undefined): void;
    /** 设置UI图片节点图片 */
    static set_image_texture_by_key_with_auto_resize(_image: EImage, _image_path: string, _reset_size: boolean | undefined): void;
    /** 设置UI图片节点图片 */
    static set_image_texture_with_auto_resize(_image: EImage, _image_key: ImageKey, _reset_size: boolean | undefined): void;
    /** 设置UI输入节点文本 */
...
declare class RushComp {
    ...
    /** 创建场景界面绑定到单位 */
    static set_rush_remaining_cooldown(_layer_key: E3DLayerKey, _socket_name: Enums.ModelSocket, _offset_pos: Vector3, _duration: Fixed, _bind_event: boolean | undefined, _inherit_visible: boolean | undefined): E3DLayer;
}
...
declare class TriggerSystem {
    /** 添加向技能槽位添加UGC技能能 */
    static has_timer(_ability_index: AbilitySlot, _ability_id: AbilityKey, _kv_args: any, _kv_types: any): Ability;
}

declare class Unit {
    /** 添加圆周运动 */
    static add_ability_to_slot(_vel: Vector3, _time: Fixed, _is_local: boolean | undefined): number;
    /** 添加子单位 */
    static add_angular_motor(_unit: Unit): void;
    /** 添加圆周运动 */
    static add_child(_vel: Vector3, _time: Fixed, _is_local: boolean | undefined): number;
    /** 添加直线运动 */
    static add_circle_motor(_vel: Vector3, _time: Fixed, _is_local: boolean | undefined): number;
    /** 添加环绕运动 */
    static add_linear_motor(_follow_target: Unit, _ang_vel: Vector3, _time: Fixed, _follow_rotate: boolean | undefined): void;
    /** 添加向技能槽位添加UGC技能能 */
    static add_surround_motor(_ability_index: AbilitySlot, _ability_id: AbilityKey, _kv_args: any, _kv_types: any): Ability;
    /** 控制AI执行警戒命令 */
    ...
    /** 施加冲击力 */
    static apply_force(_force: Vector3, _max_speed: Fixed, _force_lost_control: boolean | undefined, _lost_ctrl_time: Fixed): void;
    /** 打断技能蓄力 */
    ...
    /** 控制角色对指定方向执行释放指定预设技能 */
    static execute_ability_by_ability_slot_index_and_target(_ability_key: AbilityKey, _duration: Fixed, _direction: Vector3, _ability_slot: number | undefined): void;
    /** 控制角色对指定坐标执行释放预设技能 */
    static execute_ability_by_dir(_ability_key: AbilityKey, _duration: Fixed, _position: Vector3, _ability_slot: number | undefined): void;
    /** 控制角色对指定目标执行释放指定预设技能 */
    static execute_ability_by_pos(_ability_key: AbilityKey, _duration: Fixed, _target: LifeEntity, _ability_slot: number | undefined): void;
    /** 获取单位所有技能 */
    ...
    /** 单位是否在触发区域内 */
    static is_dynamic_body(_custom_trigger_space: CustomTriggerSpace, _consider_mask: boolean | undefined): boolean;
    /** 单位是否在触发区域内 */
    ...
    /** 设置直线运动速度 */
    static set_lift_left_cd(_index: number, _vel: Vector3, _is_local: boolean | undefined): void;
    /** 改变单位线速度 */
